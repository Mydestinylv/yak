...
use app\admin\action\HelpfulListAction;
use app\common\controller\Admin;
use think\Request;
use think\Log;
class HelpfulList extends Admin
{
    /**
     * 显示资源列表
     */
    public function index(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param, 'app\admin\validate\HelpfulList.index');
            if ($result !== true) {
                return format($result);
            }
            $transfer = HelpfulListAction::index($param);
            if (!$transfer->status) {
    ...
    public function save(Request $request)
    {
        try {
            $param = $request->post();
            $result = $this->validate($param,'app\admin\validate\HelpfulList.save');
            if ($result !== true) {
                return format($result);
            }
    ...
    public function read(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param,'app\admin\validate\HelpfulList.read');
            if ($result !== true) {
                return format($result);
            }
    ...
    public function update(Request $request)
    {
        try {
            $param = $request->post();
            $result = $this->validate($param,'app\admin\validate\HelpfulList.update');
            if ($result !== true) {
                return format($result);
            }
    ...
    public function delete(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param,'app\admin\validate\HelpfulList.delete');
            if ($result !== true) {
                return format($result);
            }
