...
use app\admin\action\HelpfulProjectAction;
use app\common\controller\Admin;
use think\Request;
use think\Log;
class HelpfulProject extends Admin
{
    /**
     * 显示资源列表
     */
    public function index(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param, 'app\admin\validate\HelpfulProject.index');
            if ($result !== true) {
    ...
    public function save(Request $request)
    {
        try {
            $param = $request->post();
            $param['project_cover'] = Request()->file('project_cover');
            $result = $this->validate($param,'app\admin\validate\HelpfulProject.save');
            if ($result !== true) {
                return format($result);
            }
    ...
    public function read(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param,'app\admin\validate\HelpfulProject.read');
            if ($result !== true) {
                return format($result);
            }
    ...
    public function update(Request $request)
    {
        try {
            $param = $request->post();
            $param['project_cover'] = Request()->file('project_cover');
            $result = $this->validate($param,'app\admin\validate\HelpfulProject.update');
            if ($result !== true) {
                return format($result);
            }
    ...
    public function delete(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param,'app\admin\validate\HelpfulProject.delete');
            if ($result !== true) {
                return format($result);
            }
