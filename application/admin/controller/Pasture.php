...
use app\admin\action\PastureAction;
use app\common\controller\Admin;
use think\Request;
use think\Log;
class Pasture extends Admin
{
    /**
     * 显示资源列表
     */
    public function index(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param, 'app\admin\validate\Pasture.index');
            if ($result !== true) {
    ...
    public function read(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param,'app\admin\validate\Pasture.read');
            if ($result !== true) {
                return format($result);
            }
    ...
    public function delete(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param,'app\admin\validate\Pasture.delete');
            if ($result !== true) {
                return format($result);
            }
