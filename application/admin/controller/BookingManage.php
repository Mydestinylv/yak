...
use app\admin\action\BookingManageAction;
use app\common\controller\Admin;
use think\Request;
use think\Log;
class BookingManage extends Admin
{
    /**
     * 显示资源列表
     */
    public function index(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param, 'app\admin\validate\BookingManage.index');
            if ($result !== true) {
    ...
    public function save(Request $request)
    {
        try {
            $param = $request->post();
            $result = $this->validate($param,'app\admin\validate\BookingManage.save');
            if ($result !== true) {
                return format($result);
            }
    ...
    public function read(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param,'app\admin\validate\BookingManage.read');
            if ($result !== true) {
                return format($result);
            }
    ...
    public function update(Request $request)
    {
        try {
            $param = $request->post();
            $result = $this->validate($param,'app\admin\validate\BookingManage.update');
            if ($result !== true) {
                return format($result);
            }
    ...
    public function delete(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param,'app\admin\validate\BookingManage.delete');
            if ($result !== true) {
                return format($result);
            }
    ...
    {
        return $this->fetch('bookingManage/lists');
    }
}
