...
use app\admin\action\WithdrawalAction;
...
class Withdrawal extends Admin
{
    ...
    public function index(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param, 'app\admin\validate\Withdrawal.index');
            if ($result !== true) {
                return format($result);
            }
            $transfer = WithdrawalAction::index($param);
            if (!$transfer->status) {
    ...
    public function save(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param,'app\admin\validate\Withdrawal.save');
            if ($result !== true) {
                return format($result);
            }
            $transfer = WithdrawalAction::save($param);
            if (!$transfer->status) {
    ...
    public function read(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param,'app\admin\validate\Withdrawal.read');
            if ($result !== true) {
                return format($result);
            }
            $transfer = WithdrawalAction::read($param);
            if (!$transfer->status) {
    ...
    public function update(Request $request)
    {
        try {
            $param = $request->post();
            $result = $this->validate($param,'app\admin\validate\Withdrawal.update');
            if ($result !== true) {
                return format($result);
            }
    ...
    public function delete(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param,'app\admin\validate\Withdrawal.delete');
            if ($result !== true) {
                return format($result);
            }
