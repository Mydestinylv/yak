...
use app\move\action\RealNameAuthAction;
use think\Request;
use think\Log;
class RealNameAuth extends App
{
    /**
     * 显示资源列表
     */
    public function index(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param, 'app\move\validate\RealNameAuth.index');
            if ($result !== true) {
    ...
    public function save(Request $request)
    {
        try {
            $param = $request->post();
            $result = $this->validate($param,'app\move\validate\RealNameAuth.save');
            if ($result !== true) {
                return format($result);
            }
            $transfer = RealNameAuthAction::save($param,CID);
            if (!$transfer->status) {
    ...
    public function read(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param,'app\move\validate\RealNameAuth.read');
            if ($result !== true) {
                return format($result);
            }
    ...
    public function update(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param,'app\move\validate\RealNameAuth.update');
            if ($result !== true) {
                return format($result);
            }
    ...
    public function delete(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param,'app\move\validate\RealNameAuth.delete');
            if ($result !== true) {
                return format($result);
            }
