...
use app\move\action\YaksAction;
use think\Request;
use think\Log;
class Yaks extends App
{
    ...
    public function index(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param, 'app\move\validate\Yaks.index');
            if ($result !== true) {
                return format($result);
            }
            $transfer = YaksAction::index($param,CID);
            if (!$transfer->status) {
    ...
    public function save(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param,'app\move\validate\Yaks.save');
            if ($result !== true) {
                return format($result);
            }
    ...
    public function read(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param,'app\move\validate\Yaks.read');
            if ($result !== true) {
                return format($result);
            }
    ...
    public function update(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param,'app\move\validate\Yaks.update');
            if ($result !== true) {
                return format($result);
            }
    ...
    public function delete(Request $request)
    {
        try {
            $param = $request->param();
            $result = $this->validate($param,'app\move\validate\Yaks.delete');
            if ($result !== true) {
                return format($result);
            }
