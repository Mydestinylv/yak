...
class SlaughterManTask
{
    protected static $model = 'app\common\model\SlaughterMan';
     ...
     * $group string 'id'
     * */
    public static function join($table, $join_file, $action, $where, $field, $order = 'create_time desc',$group = '',$select = 'paginate')
    {
