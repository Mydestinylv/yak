...
class HelpfulListTask
{
    protected static $model = 'app\common\model\HelpfulList';
     ...
     * $group string 'id'
     * */
    public static function Mjoin($table, $join_file, $action, $where, $field, $order = 'id asc',$select = 'paginate')
    {
