...
class TaskManageTask
{
    protected static $model = 'app\common\model\TaskManage';
     ...
     * $group string 'id'
     * */
    public static function Mjoin($table, $join_file, $action, $where, $field, $order = 'creaete_time desc')
    {
