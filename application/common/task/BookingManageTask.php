...
class BookingManageTask
{
    protected static $model = 'app\common\model\BookingManage';
     ...
     * $group string 'id'
     * */
    public static function join($table,$join_file,$action,$where, $field, $order = 'create_time desc',$select = 'paginate')
    {
