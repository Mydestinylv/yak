...
class RealNameAuthTask
{
    protected static $model = 'app\common\model\RealNameAuth';
     ...
     * $group string 'id'
     * */
    public static function join($table,$join_file,$action,$where, $field, $order = 'id asc',$paginate = 0)
    {
        //读配置文件
        if (!$paginate) {
            $config = config('paginate');
